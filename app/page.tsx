  ...
  return (
    <div className="flex flex-col justify-center h-screen w-full gap-10 font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="grid grid-cols-4 gap-4 px-32">
        ...
        <div className="flex flex-col bg-gradient-to-br from-dark-2 to-dark border-dark border-2 shadow-lg rounded-lg p-10 text-center hover:-translate-y-4 hover:scale-105 duration-300">
